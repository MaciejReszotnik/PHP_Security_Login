...
$insertQuery="INSERT INTO users (user_id, password_hash, salt, last_login) VALUES ('".$user."', '".$pw_hash."', '".$salt."', NOW())";
$insertResult = mysql_query($insertQuery);

mysql_close($link);

//umieszczanie mini-haseł w bazie.
